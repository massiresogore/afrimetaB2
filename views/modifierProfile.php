        ...
        <div class="profile__info">
            <div class="profile_infi-modif">
                ...
                <a href="index.php?page=profile&id=<?= $user->getId() ?>">
                    <div class="profile_info-img"><img
                ...
                <div class="sexe">
                    <p class="sexe"><span class="titre-profile">Sexe :</span>
                        <?= (isset($profile)) ?  $profile->getSexe() : "" ?></p>
                </div>
            </div>
            ...
            <div class="profile__info-modif">
                ...
                <div class="dispo">
                    <p class="dispo"><span class="titre-profile">Disponibilite :</span>
                        <?= (isset($profile) && $profile->getDisponibilite() == false) ?  "non disponible" : " disponible" ?>
                    </p>
                </div>
                <p class="pseudo"></p>
                ...
                <div class="profile__row-1-block"><i class="fa-brands fa-github"></i><span class="titre-profile">Github
                        :</span> <a href="<?= (isset($profile)) ?  $profile->getGithub() : "" ?>"
                ...
                <div class="profile__row-1-block">
                    <div class="biogragphie"><span class="titre-profile">Description :
                        </span><?= (isset($profile)) ?  $profile->getBiographie() : "" ?></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="profile__row-2">
        ...
        <div class="profile__row-2-modif">
            ...
            <form action="" method="post" class="form" id="contactForm" enctype="multipart/form-data">
                ...
                <div class="form__group">
                    ...
                    <input classe="input" type="text" name="ville"
                        value="<?= (isset($profile)) ?  $profile->getVille() : "" ?>" id="ville" required>
                </div>

                <!-- pays field -->
                <div class="form__group">
                    <label for="pays" class="titre-profile">Pays</label>
                    <input classe="input" type="text" name="pays"
                        value="<?= (isset($profile)) ?  $profile->getPays() : "" ?>" id="pays" required>
                </div>
                ...
                <div class="form__group">
                    ...
                    <input classe="input" type="text" name="github"
                        value="<?= (isset($profile)) ?  $profile->getGithub() : "" ?>" id="github" required>
                </div>
                <!-- facebook Confirmation -->
                <div class="form__group">
                    <label for="facebook" class="titre-profile">Facebook</label>
                    <input classe="input" type="text" name="facebook"
                        value="<?= (isset($profile)) ?  $profile->getFacebook() : "" ?>" id="facebook" required>
                </div>
        </div>
        ...
        <div class="profile__row-2-modif-2">
            ...
            <div>
                ...
                <span class="ouidisponible">oui<input type="radio" value="1" name="disponibilite"
                        <?= ($profile->getDisponibilite() == "1") ?  "checked" : "" ?>></span>
                <span class="disponible">non<input type="radio" value="0" name="disponibilite"
                        <?= isset($rofile) ? "" : "checked" ?>></span>
            </div>
            ...
            <div class="form__group ">
                ...
                <textarea name="biographie"
                    id="biographie"><?= (isset($profile)) ?  $profile->getBiographie() : "" ?></textarea>
            </div>
